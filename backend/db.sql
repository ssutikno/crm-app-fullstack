...
DROP TABLE IF EXISTS customer_attachments, deal_stages, role_permissions, permissions, quote_line_items, quotes, tasks, product_requests, deals, leads, contacts, customers, products, users, roles CASCADE;
...
-- Table for product-specific attachments
